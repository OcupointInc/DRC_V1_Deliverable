...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_util_ds_buf_7_1 -prefix
--               design_1_util_ds_buf_7_1_ design_1_util_ds_buf_10_1_sim_netlist.vhdl
...
entity design_1_util_ds_buf_7_1_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_1_util_ds_buf_7_1_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_1_util_ds_buf_7_1_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_1_util_ds_buf_7_1_util_ds_buf : entity is "IOBUF";
  attribute C_MODE : string;
  attribute C_MODE of design_1_util_ds_buf_7_1_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of design_1_util_ds_buf_7_1_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of design_1_util_ds_buf_7_1_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_1_util_ds_buf_7_1_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_1_util_ds_buf_7_1_util_ds_buf : entity is 1;
end design_1_util_ds_buf_7_1_util_ds_buf;

architecture STRUCTURE of design_1_util_ds_buf_7_1_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_util_ds_buf_7_1 is
  port (
    IOBUF_IO_T : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_O : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of design_1_util_ds_buf_7_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_util_ds_buf_7_1 : entity is "design_1_util_ds_buf_10_1,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_util_ds_buf_7_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_util_ds_buf_7_1 : entity is "util_ds_buf,Vivado 2023.1";
end design_1_util_ds_buf_7_1;

architecture STRUCTURE of design_1_util_ds_buf_7_1 is
...
begin
U0: entity work.design_1_util_ds_buf_7_1_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
